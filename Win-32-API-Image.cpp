...
HMENU hMenu;
HWND hEdit, hName, hAge, hOut, hButton, hLogo;
...
int WINAPI WinMain(HINSTANCE HInstance, HINSTANCE HPrevInstance, PSTR szCmdLine, int iCmdShow){
	...
	// WS: Windows Style
	CreateWindowW(L"MyWindows", L"Windows Application", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 100, 100, 700, 500, 
		NULL, NULL, NULL, NULL);
...
void addControls(HWND hWnd) {
	...
	hLogo = CreateWindowW(L"static", NULL, WS_VISIBLE | WS_CHILD | SS_BITMAP, 360, 60, 100, 100,
		hWnd, NULL, NULL, NULL);
...
void loadImages(HWND hWnd) {
	try
	{
		hLogoImage = (HBITMAP)LoadImage(NULL, MAKEINTRESOURCE(IDB_BITMAP1), IMAGE_BITMAP, 100, 100, LR_COPYFROMRESOURCE);
